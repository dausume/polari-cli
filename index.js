...
const commands = {
  ...
  iso:      { script: 'iso.sh',      desc: 'New computers: the probe kit, compatibility, unattended Ubuntu + Polari images, the Ventoy stick' },
  ...
  jenkins:  { script: 'jenkins.sh',  desc: 'Host-tier build + publish controller (polari-jenkins/): up/status/doctor/preflight/target/secrets', aliases: ['ci'] },
